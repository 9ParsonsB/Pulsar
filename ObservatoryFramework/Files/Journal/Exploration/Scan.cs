...
public class Scan : ScanBaryCentre
{
    ...
    /// <summary>
    ///     Type of scan which generated the event. Possible options include "Detailed", "AutoScan", and "NavBeaconDetail"
    ///     (non-exhaustive).
    /// </summary>
    ...
    /// <summary>
    ///     List which reflects Frontier's JSON structure for the "Parents" object. Use of Parent property is recommended
    ///     instead.
    /// </summary>
    public List<Parent> Parents
    {
        ...
        init
        {
            ...
            foreach (var parent in value)
                ...
                else if (parent.Star != null) ParentList.Add((ParentType.Star, parent.Star.GetValueOrDefault(0)));
    ...
    /// <summary>
    ///     Whether the planet can be or has been terraformed. Options include "Terraformable", "Terraformed", or ""
    ///     (non-terraformable or naturally earth-like).
    /// </summary>
    ...
    /// <summary>
    ///     Descriptive string for type of volcanism present, or an empty string for none, e.g. "major silicate vapour geysers
    ///     volcanism".
    /// </summary>
    ...
    /// <summary>
    ///     Description of the minable material abundance.<br />Possible values inclue "PristineResources", "MajorResources",
    ///     "CommonResources", "LowResources", and "DepletedResources".
    /// </summary>
