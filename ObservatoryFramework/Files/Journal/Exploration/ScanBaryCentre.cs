...
/// <summary>
///     Barycentre orbital properties, automatically recorded when any member of a multiple-body orbital arrangement is
///     first scanned.
/// </summary>
public class ScanBaryCentre : JournalBase
{
    ...
    /// <summary>
    ///     Orbital semi-major axis in metres.<br />Distance from the body's centre of gravity to the parent's centre of
    ///     gravity at the most distant point in the orbit.
    /// </summary>
    public float SemiMajorAxis { get; init; }

    /// <summary>
    ///     Orbital eccentricity.<br />0: perfectly circular, 0 &gt; x &gt; 1: eccentric, 1: parabolic (escape) trajectory.
    ///     <br />(You should not ever see 1 or 0.)
    /// </summary>
