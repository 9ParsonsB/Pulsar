...
/// <summary>
///     Interface passed by Observatory Core to plugins. Primarily used for sending notifications and UI updates back to
///     Core.
/// </summary>
public interface IObservatoryCore
{
    ...
    /// <summary>
    ///     Shared application HttpClient object. Provided so that plugins can adhere to .NET recommended behaviour of a single
    ///     HttpClient object per application.
    /// </summary>
    ...
    /// <returns>
    ///     Guid associated with the notification during its lifetime. Used as an argument with CancelNotification and
    ///     UpdateNotification.
    /// </returns>
    ...
    /// <summary>
    ///     Update an active notification with a new set of NotificationsArgs. Timeout values are reset and begin counting
    ///     again from zero if specified.
    /// </summary>
    ...
    /// <summary>
    ///     Sends arbitrary data to all other plugins. The full name and version of the sending plugin will be used to identify
    ///     the sender to any recipients.
    /// </summary>
