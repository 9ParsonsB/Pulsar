...
///     <para>
///         Note: Not intended to be implemented on its own and will not define a functional plugin. Use
///         IObservatoryWorker, IObservatoryNotifier, or both, as appropriate.
///     </para>
/// </summary>
public interface IObservatoryPlugin
{
    ...
    /// </summary>
    /// <param name="observatoryCore">
    ///     Object implementing Observatory Core's main interface. A reference to this object should
    ///     be maintained by the plugin for communication back to Core.
    /// </param>
...
///     <para>
///         Work required on plugin startup — for example object instantiation — can be done in the constructor or Load()
///         method.<br />
...
public interface IObservatoryWorker : IObservatoryPlugin
{
    ...
    /// <param name="journal">
    ///     <para>Elite Dangerous journal event, deserialized into a .NET object.</para>
    ///     <para>
    ...
    ///     </para>
    ///     <para>Unhandled journal event types will be type JournalBase with all values contained in AdditionalProperties.</para>
    /// </param>
