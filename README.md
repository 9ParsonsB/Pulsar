...
A Cross Platform Fork of Elite Observatory Core. Focus on Linux platforms.
...
- [x] !System Exploration Value
    - [x] Custom Criteria (e.g. "Has Water World", "more than 400Kcr Scan value")
- [x] !System Exobiology Value
    - [x] !Exobiology Scan
      info (+[Show Req. Distance](https://github.com/EDCD/EDDI/blob/e28ef64a1d41c1e39485863aa362d207e8d36834/Utilities/Functions.cs#L128C1-L152C10)
      for next scan)
...
- [x] !Fuel/Jump Warning
    ...
    - [x] Fuel Warning (Visual/Audio cues in UI)
- [ ] Material Tracking (Flag planets with materials, set goals (Mat#, not modules), closest
  trader) [e.g.](https://github.com/jixxed/ed-odyssey-materials-helper)
